package net.savantly.repository;

import net.savantly.ExampleJavaApp;
import net.savantly.config.Constants;
import net.savantly.config.audit.AuditEventConverter;
import net.savantly.domain.PersistentAuditEvent;
...
import static net.savantly.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
